...
\begin{itemize}
	\item \hyperref[sec:optimization]{Optimization models}: \texttt{Weeks 1 -- 4}
	\item \hyperref[sec:dynamical]{Dynamical models}: \texttt{Weeks 5 -- 9}
	\item \hyperref[sec:probability]{Probability models}: \texttt{Weeks 10 -- 11}
\end{itemize}
