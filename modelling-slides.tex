...
\begin{problem}%[Constrained Optimization]
...
\textbf{Sensitivity}. To compute $p^\star$, you can use \href{https://github.com/bigfatbernie/IBLMathModeling/blob/main/python/chairs_sensitivity.ipynb}{\texttt{chairs_sensitivity.ipynb}}.
...
If we reduce the total load ($X$) by 1 MW, it would approximately reduce the total cost of operating the three power plants by \$15/h.
...
\begin{parts}
	...
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\item Use \href{https://github.com/bigfatbernie/IBLMathModeling/blob/main/python/farm-linearprog.ipynb}{\texttt{farm-linearprog.ipynb}} to find the solution.
...
\begin{center}
	\includegraphics[height=.75\textheight]{images/farm-linearprog.png}
\end{center}
