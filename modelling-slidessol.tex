...
\includegraphics[width=0.4\textwidth]{Python - Jupyter NB/Stadium-Euler-ipynb.pdf}
...
\includegraphics[width=0.75\textwidth]{Python - Jupyter NB/sphere-dimensionanalysis.pdf}
...
\setcounter{partsitem}{3}
	...
	\item Leveraging python. Go to \url{https://utoronto.syzygy.ca/jupyter}, load the file \url{FILE_URL} and introduce the profit function and an initial guess.
\end{parts}
\end{slide}
